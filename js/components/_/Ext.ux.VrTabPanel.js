/**
 * @class Ext.ux.VrTabPanel
 * @version		0.1
 * @author Totti Anh Nguyen (tot2ivn@gmail.com)
...
Ext.ux.VrTabPanel = Ext.extend(Ext.Panel,  {
    /**
    ...
    onRender : function(ct, position){
        Ext.ux.VrTabPanel.superclass.onRender.call(this, ct, position);
        ...
        if(!this.itemTpl){
            ...
            tt.compile();
            Ext.ux.VrTabPanel.prototype.itemTpl = tt;
        }
    ...
    // private
    onAdd : function(c){
        Ext.ux.VrTabPanel.superclass.onAdd.call(this, c);
        if(this.rendered){
    ...
    onRemove : function(c){
        ...
        Ext.ux.VrTabPanel.superclass.onRemove.call(this, c);
        this.stack.remove(c);
        delete c.tabEl;
