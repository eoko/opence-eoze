...
Ext.ux.ToolbarDroppable = Ext.extend(Object, {
     ...
     * drag event
	 * rx --- fixed the "always drop at the begining" bug
     * @param {Ext.EventObject} e The event object
     * @return {Number} The index at which to insert the new button
     */
    calculateEntryIndex: function(e) {
		return this.calculateBaseEntryIndex(e);
	},

	/**
	 * rx
	 */
	calculateBaseEntryIndex: function(e) {
        var entryIndex = 0,
...
//            xHover     = e.getXY()[0] - xTotal;
        ...
        for (var index = 0; index < count; index++) {
            var item     = items[index],
				itemEl   = item.getEl(),
                width    = itemEl.getWidth(),
//                midpoint = xTotal + width / 2;
                midpoint = itemEl.getLeft() + itemEl.getWidth() / 2;
