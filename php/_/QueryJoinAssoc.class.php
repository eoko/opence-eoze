...
//class QueryJoinAssoc_AssocAliaser implements QueryAliasable {
//	
//	/**
//	 * @var QueryJoinAssoc
//	 */
...
//		return $this->join->getContext();
//	}
//
//	public function getQualifiedName($fieldName, $table = QueryJoin::TABLE_ASSOC){
//		return $this->join->getQualifiedName($fieldName, $table);
//	}
//
