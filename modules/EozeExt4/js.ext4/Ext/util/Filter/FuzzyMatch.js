...
Ext4.define('Eoze.Ext.util.Filter.FuzzyMatch', {
	...
	,createValueMatcher: function() {
		var me = this,
			...
			fuzzyMatch = true,
			ignoreAccents = me.ignoreAccents,
	...
	/**
	 * Replaces characters that can have accentuated form by all their accentuated alternatives.
	 * @param {String} string
	 * @return {String}
	 * @private
	 */
	,normalizeAccents: function() {
		...
		// http://stackoverflow.com/q/227950/1387519
		var accented = {
		...
		return function(string) {
			return string
				.replace(/\S/g, function(chr) {
					return latinMap[chr] || chr;
				})
				.replace(/\S/g, function(chr) {
