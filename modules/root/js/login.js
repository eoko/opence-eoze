Oce.Modules.root.login = Ext.extend(Oce.Module, {
	...
	,constructor: function(config) {
		Oce.Modules.root.login.superclass.constructor.call(this, config);
...
Oce.Modules.root.login = new Oce.Modules.root.login();

Oce.deps.reg('Oce.Modules.root.login');