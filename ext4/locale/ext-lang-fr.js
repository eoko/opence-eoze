...
Ext4.onReady(function() {
    ...
    Ext4.define("Ext4.locale.fr.view.View", {
        override: "Ext4.view.View",
        emptyText: ""
    });

    Ext4.define("Ext4.locale.fr.grid.Panel", {
        override: "Ext4.grid.Panel",
        ddText: "{0} ligne{1} sélectionnée{1}"
    });

    // changing the msg text below will affect the LoadMask
    Ext4.define("Ext4.locale.fr.view.AbstractView", {
    ...
    Ext4.define("Ext4.locale.fr.picker.Month", {
        override: "Ext4.picker.Month",
        okText: "&#160;OK&#160;",
        cancelText: "Annuler"
    });

    Ext4.define("Ext4.locale.fr.toolbar.Paging", {
    ...
    Ext4.define("Ext4.locale.fr.form.field.Number", {
    ...
    Ext4.define("Ext4.locale.fr.form.field.ComboBox", {
    ...
    Ext4.define("Ext4.locale.fr.form.field.HtmlEditor", {
    ...
    Ext4.define("Ext4.locale.fr.grid.header.Container", {
    ...
    Ext4.define("Ext4.locale.fr.grid.GroupingFeature", {
    ...
    Ext4.define("Ext4.locale.fr.grid.PropertyColumnModel", {
